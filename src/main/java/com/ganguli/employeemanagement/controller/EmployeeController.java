...
public class EmployeeController {
	...
	@PostMapping("/add")
	public ResponseEntity<EmployeeDTO> addEmployee(@Valid @RequestBody EmployeeDTO employeeDTO) throws BadRequestException {
		return new ResponseEntity<>(employeeService.addEmployee(employeeDTO), HttpStatus.CREATED);
	}
	
	@PutMapping("/edit/{employeeId}")
	public ResponseEntity<EmployeeDTO> editEmployee(@PathVariable Long employeeId, @Valid @RequestBody EmployeeDTO employeeDTO) 
