...
public class DepartmentController {
	...
	@PostMapping("/add")
	public ResponseEntity<DepartmentDTO> addDepartment(@Valid @RequestBody DepartmentDTO departmentDTO) throws BadRequestException {
		return new ResponseEntity<>(departmentService.addDepartment(departmentDTO), HttpStatus.CREATED);
	}
	
	@PutMapping("/edit/{departmentId}")
	public ResponseEntity<DepartmentDTO> editDepartment(@PathVariable Long departmentId, @Valid @RequestBody DepartmentDTO departmentDTO) 
